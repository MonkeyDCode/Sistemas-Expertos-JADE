...
public class Minimizar extends javax.swing.JFrame {
    ...
    int bandera =0;
    public Minimizar(int c1,int pos1, int c2, int pos2, int pM){
        this.cambiar1 = c1;
        this.cambiar2 = c2;
        this.parMenor = pM;
        this.pos1 = pos1;
    ...
    public Minimizar(int c1,int pos1, int c2, int pos2, int pM,int[] vUsadas,int b){
        this.cambiar1 = c1;
        this.cambiar2 = c2;
        this.parMenor = pM;
        this.pos1 = pos1;
    ...
    public void siguienteRonda(){
        ...
        if(this.bandera==0){
            Minimizar vMini = new Minimizar(this.cambiar1,
                    this.buscarPosicion(this.cambiar1, this.particulaMenor(this.elegirMenor())),
                    this.cambiar2,
                    this.buscarPosicion(this.cambiar2, this.particulaMenor(this.elegirMenor())),
                    this.elegirMenor(),
                    this.vecAux,
                    1);                
