...
public class Ginecologo extends Agent {
    ...
    class GinecologoeBehaviour extends SimpleBehaviour {
        ...
        do{   
            ...
            prinII.frame.getJLabel3().setIcon(new ImageIcon("ginecologoTG.png"));
            prinII.frame.getJLabel2().setIcon(new ImageIcon("terapeutaT.png"));
            ...
            prinII.frame.getJLabel3().setIcon(new ImageIcon("ginecologoT.png"));
            prinII.frame.getJLabel2().setIcon(new ImageIcon("terapeutaTG.png"));
        ...
        private void ComunicaPsicologo() throws CodecException, OntologyException, IOException {
            ...
            do{   
                ...
                prinII.getJTextArea4().setText("");
                prinII.frame.getJLabel3().setIcon(new ImageIcon("ginecologoTG.png"));
                prinII.frame.getJLabel1().setIcon(new ImageIcon("psicologoTT.png"));
                ...
                prinII.frame.getJLabel3().setIcon(new ImageIcon("ginecologoT.png"));
                prinII.frame.getJLabel1().setIcon(new ImageIcon("psicologoTTG.png"));
                prinII.jPanel1.updateUI();
                prinII.repaint();
        }
