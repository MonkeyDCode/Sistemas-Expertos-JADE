...
public class ThreadRecibe implements Runnable {
   ...
   public ThreadRecibe(Socket cliente, Gerente main){
       this.cliente = cliente;
       this.main = main;
   }  
 
    public void mostrarMensaje(String mensaje) {
        //main.areaMuestra.append(mensaje);
        System.out.println("Si_ "+mensaje);
    }
    ...
    public void run() {
        ...
        do { //procesa los mensajes enviados dsd el servidor
            try {//leer el mensaje y mostrarlo
                ...
                //ven.setJTxtArea4(mensaje);
               // Paqueteria.areaMuestra.setText("");
               // Paqueteria.areaMuestra.append(mensaje);
            } //fin try
